...
<form method="POST" action="{{ route('port.update', $data->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class="row justify-content-center py-sm-3 py-md-5">
                <div class="col-sm-10 col-md-8">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control form-control-alt" name="nama" value="{{ $data->nama }}" placeholder="Masukan Nama Port...">
                    </div>
                </div>
            </div>
        </div>
