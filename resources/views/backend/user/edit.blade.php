...
<form method="POST" action="{{ route('user.update', $data->id) }}" enctype="multipart/form-data">
    ...
    <div class="block block-rounded">
            ...
            <div class="row justify-content-center py-sm-3 py-md-5">
                <div class="col-sm-10 col-md-8">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control form-control-alt" id="block-form7-username" name="username" value="{{ $data->name }}" placeholder="Enter your username..">
                    </div>
                    <div class="mb-4">
                        <label class="form-label" for="block-form7-username">Email</label>
                        <input type="email" class="form-control form-control-alt" id="block-form7-email" name="email" value="{{ $data->email }}" placeholder="Enter your Email..">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                      ...
                      <select class="form-select" id="role" name="role">
                        ...
                        <option value="0" {{ ( $data->role == 'admin') ? 'selected' : '' }}>Admin</option>
                        <option value="1" {{ ( $data->role == 'user') ? 'selected' : '' }}>User</option>
                      </select>
                    </div>
                </div>
            </div>
        ...
        <div class="block-content block-content-full block-content-sm bg-body-light">
            ...
            <a href="{{ route('user.index') }}" class="btn btn-sm btn-alt-danger">
